  ...
  const submission = (data) => {
    AxiosInstance.post('api/login/', {
      ...
      .then((response) => {
        ...
        const { is_rh, is_employe, is_candidat  , profile_picture } = user;
        ...
        // Sauvegarder les rôles utilisateur dans localStorage
        localStorage.setItem('UserRole', JSON.stringify({ is_rh, is_employe, is_candidat }));

        // Afficher les tokens dans la console pour vérification
        console.log('Access Token:', access);
        console.log('Refresh Token:', refresh);
        console.log('User Roles:', { is_rh, is_employe, is_candidat });
        console.log('User picture:', profile_picture );
          
  

        // Vérifier si l'utilisateur est un candidat et rediriger
        if (is_candidat) {
          navigate('/acceuilCandidat');
        } else {
          // Si ce n'est pas un candidat, rediriger vers le dashboard
          navigate('/dashboard');
        }
